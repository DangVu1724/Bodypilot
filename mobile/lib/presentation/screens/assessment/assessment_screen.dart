...
import 'package:mobile/presentation/screens/assessment/steps/allergy_option_step.dart';
...
import 'package:mobile/presentation/screens/assessment/steps/exercise_step.dart';
...
import 'package:mobile/presentation/screens/assessment/steps/sleep_step.dart';
...
class _AssessmentScreenState extends State<AssessmentScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    steps = [
      ...
      ExerciseStep(onNext: () => nextPage(steps.length)),
      DietStep(onNext: () => nextPage(steps.length)),
      ConditionStep(onNext: () => nextPage(steps.length)),
      AllergyOptionStep(onNext: () => nextPage(steps.length)),
      SleepStep(onNext: () => nextPage(steps.length)),
    ];
