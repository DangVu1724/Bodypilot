...
class CalenderWorkout extends StatefulWidget {
  const CalenderWorkout({super.key});

  @override
  State<CalenderWorkout> createState() => _CalenderWorkoutState();
}

class _CalenderWorkoutState extends State<CalenderWorkout> {
  ...
  void _fetchMonthData(DateTime date) {
    ...
    context.read<WorkoutDiaryCubit>().fetchWeeklyWorkouts(start, end);
  }
              ...
              children: [
                TableCalendar(
                  ...
                  onDaySelected: (selectedDay, focusedDay) {
                    ...
                    context.push(AppRoutes.workoutDiary, extra: selectedDay);
                  },
                  ...
                  calendarBuilders: CalendarBuilders(
                    markerBuilder: (context, day, events) {
                      ...
                      if (dailyWorkout == null || dailyWorkout.workoutItems.isEmpty) return null;

                      bool allCompleted = dailyWorkout.isCompleted;
                      ...
                      return Positioned(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            shape: BoxShape.circle,
                            color: allCompleted ? Colors.green : const Color(0xFFFF7A30),
                          ),
                        ),
                      );
                    },
